...
# Приглашение родителя. Добавляем и удаляем студентов, т.к. уже могут быть все приглашены
    def test_03_invite(self):
        ...
        self.assertTrue(count_invite_1 < count_invite_2, 'Приглашение не отправлено')
        time.sleep(2)
        del_student(self)
